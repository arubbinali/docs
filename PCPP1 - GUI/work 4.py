...
query_text = ctk.CTkLabel(window, text = "Enter the table to view\n\n\n\n\n\n\n\n\nEnter an insert, update or delete query", justify = "left")
query_text.place(x = secondx, y = firsty + 10)
select_database_text = ctk.CTkLabel(window, text = "Enter database to use")
...
table_in = ctk.CTkEntry(window, placeholder_text = "Type in the table name here", width = 350)
table_in.place(x = secondx, y = firsty + 40)
database_in = ctk.CTkEntry(window, placeholder_text = "Type in the database name here", width = 350)
...
show_table_button = ctk.CTkButton(window, text = "Show table [ENTER]", command = run_table, width = 200, fg_color="#313338", hover_color="#494D54")
...
show_databases_button = ctk.CTkButton(window, text = "Show databases", command = show_databases, fg_color="#313338", hover_color="#494D54")
show_databases_button.place(x = firstx + 150, y = 770)
show_tables_button = ctk.CTkButton(window, text = "Show tables", command = show_tables, fg_color="#313338", hover_color="#494D54")
show_tables_button.place(x = firstx + 301, y = 770)
select_database_button = ctk.CTkButton(window, text = "Select database", command = get_database, fg_color="#313338", hover_color="#494D54")
